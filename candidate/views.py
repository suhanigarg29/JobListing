...
def job_detail(request, slug):
    ...
    return render(request, 'candidate/job_detail.html', {'job': job, 'profile': profile, 'apply_button': apply_button, 'save_button': save_button, 'relevant_jobs': relevant_jobs, 'candidate_navbar': 1})
...
def saved_jobs(request):
    ...
    return render(request, 'candidate/saved_jobs.html', {'jobs': jobs, 'candidate_navbar': 1})
...
# view which handles display of relevant jobs according to skills of the user
@login_required
def intelligent_search(request):
    ...
    return render(request, 'candidate/intelligent_search.html', context)
